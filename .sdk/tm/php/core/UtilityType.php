...
// OpenBreweryDb SDK utility type

class OpenBreweryDbUtility
{
    ...
    public static function copy(OpenBreweryDbUtility $src): OpenBreweryDbUtility
    {
        $u = new OpenBreweryDbUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
