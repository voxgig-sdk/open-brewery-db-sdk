...
// OpenBreweryDb SDK netsim feature
...
class OpenBreweryDbNetsimFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _simulate(OpenBreweryDbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenBreweryDbContext $ctx, array $applied): void
    {
        $client = $this->client;
