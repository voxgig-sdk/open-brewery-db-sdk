...
// OpenBreweryDb SDK rbac feature
...
class OpenBreweryDbRbacFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _required(OpenBreweryDbContext $ctx): ?string
    {
    ...
    private function _reject(OpenBreweryDbContext $ctx, string $required): void
    {
    ...
    private function _track(OpenBreweryDbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
