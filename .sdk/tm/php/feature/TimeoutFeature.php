...
// OpenBreweryDb SDK timeout feature
...
class OpenBreweryDbTimeoutFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _with_timeout(OpenBreweryDbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenBreweryDbContext $_ctx, float $ms): void
    {
        $client = $this->client;
