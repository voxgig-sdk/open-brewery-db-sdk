...
// OpenBreweryDb SDK clienttrack feature
...
class OpenBreweryDbClienttrackFeature extends OpenBreweryDbBaseFeature
{
    ...
    public function PostConstruct(OpenBreweryDbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenBreweryDb-SDK';
