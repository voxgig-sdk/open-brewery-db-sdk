...
// OpenBreweryDb SDK telemetry feature
...
class OpenBreweryDbTelemetryFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _close(OpenBreweryDbContext $ctx, bool $ok): void
    {
