...
// OpenBreweryDb SDK utility: make_options

class OpenBreweryDbMakeOptions
{
    ...
    public static function call(OpenBreweryDbContext $ctx): array
    {
        ...
        //
        // `OpenBreweryDbSchema::optspec()` is built from the model:
        ...
        $optspec = OpenBreweryDbSchema::optspec();
