...
// OpenBreweryDb SDK utility: graphql
//
...
class OpenBreweryDbGraphql
{
    ...
    // equivalent.
    public static function body(OpenBreweryDbContext $ctx): mixed
    {
    ...
    public static function errors(OpenBreweryDbContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
