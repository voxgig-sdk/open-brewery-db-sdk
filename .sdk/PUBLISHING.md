...
|---|---|---|
| `ts/` | @voxgig-sdk/open-brewery-db-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-brewery-db-sdk \
      --repository voxgig-sdk/open-brewery-db-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-brewery-db-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-brewery-db-sdk --id=<id>` removes it.
