# OpenBreweryDb Ruby SDK



The Ruby SDK for the OpenBreweryDb API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `OpenBreweryDbError` (a `StandardError` subclass), so wrap
...
```
rb/
├── OpenBreweryDb_sdk.rb       -- Main SDK module
...
The main module (`OpenBreweryDb_sdk`) exports the SDK class
