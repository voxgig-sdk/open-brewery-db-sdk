...
#      offline in seeded test mode (OpenBreweryDbSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenBreweryDb_sdk.rb")
  SDK_CLASS = "OpenBreweryDbSDK"
