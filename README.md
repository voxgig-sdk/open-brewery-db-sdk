...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/open-brewery-db` | `npm install @voxgig-sdk/open-brewery-db` |
| Python | `voxgig-sdk-open-brewery-db` | `pip install voxgig-sdk-open-brewery-db` |
| PHP | `voxgig-sdk/open-brewery-db` | `composer require voxgig-sdk/open-brewery-db` |
| Golang | `github.com/voxgig-sdk/open-brewery-db-sdk/go` | `go get github.com/voxgig-sdk/open-brewery-db-sdk/go` |
| Ruby | `voxgig-sdk-open-brewery-db` | `gem install voxgig-sdk-open-brewery-db` |
| Lua | `voxgig-sdk-open-brewery-db` | `luarocks install voxgig-sdk-open-brewery-db` |
