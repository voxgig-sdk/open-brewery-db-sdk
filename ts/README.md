# OpenBreweryDb TypeScript SDK

The TypeScript SDK for the OpenBreweryDb API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `OpenBreweryDbSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `OpenBreweryDbSDK.test(testopts?, sdkopts?)` | `OpenBreweryDbSDK` | Create a test-mode client. |
...
open-brewery-db/
├── src/
│   ├── OpenBreweryDbSDK.ts        # Main SDK class
