...
AQL-driven CLI and REPL for the OpenBreweryDb SDK. Positional arguments are
...
```sh
go build -o open-brewery-db-cli ./...
```
...
./open-brewery-db-cli load 1 brewery
./open-brewery-db-cli load '{id:1}' brewery
