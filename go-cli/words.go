...
func registerSDKWords(r *eng.Registry, client *sdk.OpenBreweryDbSDK) {
...
func runOp(client *sdk.OpenBreweryDbSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
