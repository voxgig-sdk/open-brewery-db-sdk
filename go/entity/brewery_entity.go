...
func NewBreweryEntity(client *core.OpenBreweryDbSDK, entopts map[string]any) *BreweryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BreweryEntity) GetName() string { return e.name }
...
func (e *BreweryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BreweryEntity) Deleted() bool {
	return e.deleted
}


func (e *BreweryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBreweryEntity(e.client, opts)
}

func (e *BreweryEntity) Data(args ...any) any {
...
func (e *BreweryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Brewery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BreweryEntity) DataTyped(data ...Brewery) Brewery {
	if len(data) > 0 {
		return typedFrom[Brewery](e.Data(asMap(data[0])))
	}
	return typedFrom[Brewery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Brewery (all fields
// optional at the wire level).
func (e *BreweryEntity) MatchTyped(match ...Brewery) Brewery {
	if len(match) > 0 {
		return typedFrom[Brewery](e.Match(asMap(match[0])))
	}
	return typedFrom[Brewery](e.Match())
}
...
func (e *BreweryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BreweryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BreweryLoadMatch and returns an Brewery. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BreweryEntity) LoadTyped(reqmatch BreweryLoadMatch, ctrl map[string]any) (Brewery, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Brewery{}, err
	}
	return typedFrom[Brewery](res), nil
}




func (e *BreweryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BreweryListMatch and returns []Brewery. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BreweryEntity) ListTyped(reqmatch BreweryListMatch, ctrl map[string]any) ([]Brewery, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Brewery](res), nil
}



func (e *BreweryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BreweryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BreweryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BreweryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
