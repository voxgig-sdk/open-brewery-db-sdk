...
func (sdk *OpenBreweryDbSDK) OptionsMap() map[string]any {
...
func (sdk *OpenBreweryDbSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenBreweryDbSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenBreweryDbSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenBreweryDbSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenBreweryDbSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenBreweryDbSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenBreweryDbSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenBreweryDbSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenBreweryDbSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenBreweryDbSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenBreweryDbSDK {
	...
	sdk := NewOpenBreweryDbSDK(sdkopts)
	sdk.Mode = "test"
