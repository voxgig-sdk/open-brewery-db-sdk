...
// OpenBreweryDb SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenBreweryDbMakeRequest
{
    public static function call(OpenBreweryDbContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenBreweryDbResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenBreweryDbResponse($fetched);
        } else {
