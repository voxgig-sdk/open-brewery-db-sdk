...
// OpenBreweryDb SDK utility: fetcher

class OpenBreweryDbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenBreweryDbSDK/1.0)';
    ...
    public static function call(OpenBreweryDbContext $ctx, string $fullurl, array $fetchdef): array
    {
