...
// OpenBreweryDb SDK proxy feature
...
class OpenBreweryDbProxyFeature extends OpenBreweryDbBaseFeature
{
    ...
    public function init(OpenBreweryDbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenBreweryDbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
