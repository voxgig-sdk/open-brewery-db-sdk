...
// OpenBreweryDb SDK audit feature
...
class OpenBreweryDbAuditFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _emit(OpenBreweryDbContext $ctx, string $outcome): void
    {
