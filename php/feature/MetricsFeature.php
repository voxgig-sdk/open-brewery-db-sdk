...
// OpenBreweryDb SDK metrics feature
...
class OpenBreweryDbMetricsFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _record(OpenBreweryDbContext $ctx, bool $ok): void
    {
