...
// OpenBreweryDb SDK streaming feature
...
class OpenBreweryDbStreamingFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _iterate(OpenBreweryDbResult $result): \Generator
    {
    ...
    private function _streamable(OpenBreweryDbContext $ctx): bool
    {
