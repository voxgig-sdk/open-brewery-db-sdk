...
// OpenBreweryDb SDK ratelimit feature
...
class OpenBreweryDbRatelimitFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _acquire(OpenBreweryDbContext $ctx): void
    {
    ...
    private function _track(OpenBreweryDbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
