...
// OpenBreweryDb SDK cache feature
...
class OpenBreweryDbCacheFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _through(OpenBreweryDbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
