...
// OpenBreweryDb SDK idempotency feature
...
class OpenBreweryDbIdempotencyFeature extends OpenBreweryDbBaseFeature
{
    ...
    private function _mutating(OpenBreweryDbContext $ctx): bool
    {
