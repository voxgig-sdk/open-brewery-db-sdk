...
// OpenBreweryDb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenBreweryDbSDK::test)
...
{
    private const SDK_CLASS = 'OpenBreweryDbSDK';
    ...
    private const SDK_BASE = 'openbrewerydb_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openbrewerydb_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
