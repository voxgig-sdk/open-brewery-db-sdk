# OpenBreweryDb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenBreweryDbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenBreweryDbSDK(...) and OpenBreweryDbSDK.test(...) become
#      OpenBreweryDbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openbrewerydb_sdk"
_SDK_CLASS = "OpenBreweryDbSDK"
