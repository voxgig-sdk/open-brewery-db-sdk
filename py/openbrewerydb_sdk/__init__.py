...
from openbrewerydb_sdk.utility import register

# Load features
from openbrewerydb_sdk.feature.base_feature import OpenBreweryDbBaseFeature
from openbrewerydb_sdk.features import _has_feature, _make_feature
...
class OpenBreweryDbSDK:
    ...
    def get_utility(self):
        return OpenBreweryDbUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenBreweryDbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Brewery(self, data=None) -> "BreweryEntity":
        ...
        from openbrewerydb_sdk.entity.brewery_entity import BreweryEntity
