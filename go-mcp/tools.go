...
type Args struct {
	Entity string         `json:"entity" jsonschema:"brewery"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenBreweryDbSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-brewery-db_list",
		Description: "List records from OpenBreweryDb. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-brewery-db_load",
		Description: "Load a single record from OpenBreweryDb. " +
...
func runOp(client *sdk.OpenBreweryDbSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenBreweryDbSDK, name string) (sdk.OpenBreweryDbEntity, error) {
	switch strings.ToLower(name) {
	case "brewery":
		return client.Brewery(nil), nil
