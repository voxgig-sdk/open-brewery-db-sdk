// Command OpenBreweryDb-mcp is an MCP server exposing the OpenBreweryDb
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenBreweryDb_list  — list records of an entity
//	OpenBreweryDb_load  — load a single record of an entity
//
