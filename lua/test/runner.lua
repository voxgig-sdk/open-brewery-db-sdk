...
function runner.env_override(m)
  local live = runner.getenv("OPEN_BREWERY_DB_TEST_LIVE")
  local override = runner.getenv("OPEN_BREWERY_DB_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPEN_BREWERY_DB_TEST_EXPLAIN")
