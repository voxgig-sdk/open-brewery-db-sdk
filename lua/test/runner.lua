...
function runner.env_override(m)
  local live = runner.getenv("OPENBREWERYDB_TEST_LIVE")
  local override = runner.getenv("OPENBREWERYDB_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENBREWERYDB_TEST_EXPLAIN")
